...
if (isset($_GET['unidade'])) {
    ...
    if (isset($_GET['action'])) {
        if ($_POST) {
            ...
            if ($especializacao == NULL) { $arrError[] = "Selecione um <strong>especialização</strong><br/>"; }
            if ($profissao      == NULL) { $arrError[] = "Selecione uma <strong>profissão</strong><br/>";     }
            if ($periodo        == NULL) { $arrError[] = "Escolha um <strong>período</strong><br/>";          }
